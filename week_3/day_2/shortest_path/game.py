...
class game(grid,player):
	...
	def play(self):
		# infinte loop to keep the game going until the user
		# quits the game
		self.map.add_rand_obstacles(10)
		while self.game_loop:
			pygame.display.set_caption("Python Game Boot Camp")
...
## files
## exception handling
#universty of washington python 101 or 102
